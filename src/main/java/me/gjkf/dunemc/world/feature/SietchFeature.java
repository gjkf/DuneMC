...
public class SietchFeature extends StructureFeature<DefaultFeatureConfig> {

  public SietchFeature(Codec<DefaultFeatureConfig> codec) {
    super(codec);
  }
  ...
  public static class Start extends StructureStart<DefaultFeatureConfig> {
    ...
    public void init(DynamicRegistryManager registryManager, ChunkGenerator chunkGenerator, StructureManager manager, int chunkX,
      ...
      SietchGenerator.addPieces(manager, pos, rotation, this.children);
